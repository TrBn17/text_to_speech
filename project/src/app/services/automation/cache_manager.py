#!/usr/bin/env python3
"""
Cache Manager for content storage and automation workflow
"""
...
class CacheManager:
    """Manages caching for content and automation data."""
    ...
    def save_api_response(self, api_type: str, response_data: str, metadata: Dict[str, Any] = None) -> str:
        ...
        Args:
            api_type: Type of content (e.g., 'text_generation', 'tts')
            response_data: The actual content to store
        ...
        try:
            ...
            print(f"💾 Saved content to cache: {cache_key}")
...
def save_api_response(api_type: str, response_data: str, metadata: Dict[str, Any] = None) -> str:
    """Convenient function to save content to cache."""
